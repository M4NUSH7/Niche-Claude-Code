...
If not, see [Installation](install.md).
...
RTK covers all major ecosystems - Git, Cargo/Rust, JavaScript, Python, Go, Ruby, .NET, Docker/Kubernetes, and more. For the full command/filter list, run `rtk --help` or see the rtk upstream docs.
...
- Full command/filter list and supported agents: `rtk --help` or the rtk upstream docs.
- Claude Code hook setup and configuration: `references/hooks-setup.md`, `references/install.md`.
